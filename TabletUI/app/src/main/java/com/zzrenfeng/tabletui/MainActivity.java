package com.zzrenfeng.tabletui;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView navViewRight = (NavigationView) findViewById(R.id.nav_view_right);
        ...
        navViewLeft.setCheckedItem(R.id.nav_call);  //将Call菜单设置为默认选中
        ...
        navViewRight.setCheckedItem(R.id.nav_call);  //将Call菜单设置为默认选中
